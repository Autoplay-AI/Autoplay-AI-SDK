...
The canonical changelog for releases and PyPI sdists also lives in the repository as [`CHANGELOG.md`](https://github.com/Autoplay-AI/Autoplay-AI-SDK/blob/main/./CHANGELOG.md). This page mirrors that file for the documentation site, with links pointed at these docs.
...
For full **Added** / **Changed** / **Breaking** detail, see the same version in the repository [`CHANGELOG.md`](https://github.com/Autoplay-AI/Autoplay-AI-SDK/blob/main/./CHANGELOG.md).
...
- **`expire_proactive_to_thinking_if_idle`** — returns **`ProactiveIdleExpiryResult`** (use **`if result:`** / **`result.transitioned`**, not **`is True`** on the return value). See [`CHANGELOG.md`](https://github.com/Autoplay-AI/Autoplay-AI-SDK/blob/main/./CHANGELOG.md#067--2026-04-30).
