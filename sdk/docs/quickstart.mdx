...
## Choose your existing session replay provider

<AccordionGroup>
<Accordion title="PostHog" icon="/images/recipes/posthog/logo.png" iconType="image">
...
<Accordion title="FullStory (Coming soon)" icon="/images/recipes/fullstory/logo.png" iconType="image">

If your product activity source is FullStory, follow the dedicated setup guide:

- [FullStory tutorial](/recipes/fullstory/how-to-setup)

This accordion is marked **Coming soon** while the Quickstart is being refactored into source-specific end-to-end flows.

</Accordion>

<Accordion title="Datadog (Coming soon)" icon="/images/recipes/datadog/logo.png" iconType="image">

If your product activity source is Datadog, follow the dedicated setup guide:

- [Datadog tutorial](/recipes/datadog/how-to-setup)

This accordion is marked **Coming soon** while the Quickstart is being refactored into source-specific end-to-end flows.

</Accordion>

<Accordion title="Pendo (Coming soon)" icon="/images/recipes/pendo/logo.png" iconType="image">

If your product activity source is Pendo, follow the dedicated setup guide:
