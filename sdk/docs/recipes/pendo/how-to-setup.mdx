...
<Frame>
  <img src="/images/recipes/pendo/flow1.png" alt="Pendo Guides list" />
</Frame>
...
<Frame>
  <img src="/images/recipes/pendo/flow2.png" alt="Pendo Guide targeting and publish" />
</Frame>

4. Note the **Guide ID** shown in the URL bar (`/guides/<guide_id>/edit`).

<Frame>
  <img src="/images/recipes/pendo/flow3.png" alt="Pendo Guide ID in URL bar" />
</Frame>
